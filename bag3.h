...
class bag
{
    public:
        ...
        void insert(const value_type& entry);
        void operator +=(const bag& addend);
		void operator -=(const bag& subtractor);
...
// Add the - and -= operator functions using the specifications provided in the pdf. Please note: the specifications given are applicable to both.
